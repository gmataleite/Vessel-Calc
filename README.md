...
Este projeto alia 15 anos de experiência prática em engenharia mecânica a padrões modernos de desenvolvimento de software, demonstrando a aplicação de **Domain-Driven Design (DDD)** para modelar domínios matemáticos e normativos complexos.
...
O raciocínio arquitetural e as decisões de design de software estão detalhadas na pasta `/docs`.
* [Arquitetura do Sistema](./docs/architecture.md): Detalhamento da Clean Architecture e separação de camadas.
* [Modelagem das Regras ASME](./docs/regras-asme.md): Como as equações empíricas da norma foram transformadas em um modelo de domínio rico e testável.
* [ADRs (Architecture Decision Records)](./docs/adrs/): Registros formais das decisões técnicas adotadas no projeto.
